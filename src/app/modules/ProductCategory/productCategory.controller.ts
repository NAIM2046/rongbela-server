...
export const getAllCategoriesForHomePage = catchAsync(
  async (req: Request, res: Response) => {
    const result = await productCategoryService.getAllCategoriesForHomePage();
...
export const getCategoryById = catchAsync(
  async (req: Request, res: Response) => {
    const result = await productCategoryService.getCategoryById(
