...
import { createProductService, deleteProduct, getProductBySlug, getProducts, updateProduct } from "./product.service";
...
// ==========================================
export const updateSingleProduct = catchAsync(async (req: Request, res: Response) => {
...
// ==========================================
// 3. DELETE PRODUCT CONTROLLER
// ==========================================
export const deleteSingleProduct = catchAsync(async (req: Request, res: Response) => {
...
// ==========================================
// 4. GET PRODUCT BY SLUG CONTROLLER
// ==========================================
export const getSingleProductBySlug = catchAsync(async (req: Request, res: Response) => {
  const { slug } = req.params; // URL থেকে Slug নেওয়া (যেমন: /api/products/slug/:slug)
  
  if (!slug) {
    throw new ApiError(400, "Product Slug is required");
  }

  // সার্ভিস ফাংশন কল করে ডাটা নিয়ে আসা
